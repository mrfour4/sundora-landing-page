        ...
        >
            <div className="flex w-full flex-1 flex-col justify-center lg:mt-0 lg:w-auto lg:flex-row lg:items-center lg:gap-x-16">
                ...
                <div className="p-6 lg:pl-20">
                    <h1
                        className={cn(
                            "xs:text-3xl text-sundora-primary text-2xl font-light uppercase lg:text-5xl",
                            albra.className,
                        )}
                    >
                        CHẤT TINH TẾ
                    ...
                    <h2
                        className={cn(
                            "xs:text-lg text-sundora-primary-foreground mt-2 text-base lg:-translate-x-11 lg:text-xl",
                            sparkling.className,
                        )}
                    >
