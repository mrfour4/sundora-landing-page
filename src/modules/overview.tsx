...
export const Overview = () => {
  ...
  return (
    ...
    >
      <div className="relative flex-1 px-6 pt-20 lg:px-20">
        <div className="relative z-20">
          ...
          <div
            className={cn('flex items-center gap-5 lg:mt-4', albra.className)}
          >
            <h3 className="text-sm font-light text-sundora-secondary lg:text-xl">
              Cho những <br />
              chủ nhân
            </h3>
            <div className="xs:text-3xl mt-2 flex items-center gap-1 text-2xl font-light whitespace-nowrap text-white uppercase text-shadow-[0_0_10px] text-shadow-sundora-secondary lg:text-5xl">
              <h2 className="">Duy mỹ</h2>
              <Icons.and className="w-4 lg:w-8" />
              <h2>Tinh tế</h2>
            </div>
          </div>
          <p className="w-full text-justify text-xs text-sundora-secondary-foreground lg:mt-2 lg:w-1/2 lg:pr-20 lg:text-sm">
            Với vị trí tuyệt đẹp bên bờ sông Hàn, sở hữu tầm nhìn không giới hạn
            cùng thiết kế ấn tượng và hệ tiện ích cao cấp, Sundora Tower tạo nên
            phong cách sống mới tại Đà Nẵng.
          </p>
