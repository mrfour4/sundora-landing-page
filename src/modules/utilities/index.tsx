...
export const Utilities = () => {
  ...
  return (
    ...
    >
      <div className={cn('relative shrink-0 pt-8 pr-7', isMobile && 'hidden')}>
      ...
      <div className="text-center lg:text-start">
        <h1
          className={cn(
            'text-3xl font-light text-sundora-primary uppercase lg:ml-14 lg:text-5xl',
            albra.className
          )}
        >
        ...
        <h2
          className={cn(
            'text-lg text-sundora-primary-foreground lg:ml-5',
            sparkling.className
          )}
        >
          Chạm đến mọi giác quan
        </h2>
        <p className="text-muted-secondary-foreground mt-2 px-6 text-justify text-sm lg:mt-5 lg:ml-14 lg:w-[339px] lg:px-0">
          Sundora được kiến tạo như một tổ hợp sống hoàn chỉnh, nơi mọi chức
          năng - từ sống, làm việc đến nghỉ dưỡng đều được tích hợp mạch lạc
          trong một tổng thể kiến trúc tối ưu.
        </p>
        ...
        <UtilityList activeIndex={activeIndex} onChange={setActiveIndex} />
      </div>
    </section>
  );
};
