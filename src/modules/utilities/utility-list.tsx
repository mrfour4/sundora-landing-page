                ...
                {UTILITIES_DATA.map((uti, index) => {
                    ...
                    return (
                        <li
                            key={uti.imageUrl}
                            className={cn(
                                "flex w-fit cursor-pointer items-center gap-x-4 py-2 transition-transform ease-linear lg:gap-7",
                                isActive &&
                                    "xs:-translate-x-20 border-sundora-primary -translate-x-10 border-b-2 py-1",
                            )}
                        ...
                        >
                            <span
                                className={cn(
                                    ...
                                    albra.className,
                                    isActive &&
                                        "from-sundora-secondary to-sundora-secondary-foreground bg-gradient-to-b bg-clip-text text-2xl text-transparent opacity-100",
                                )}
                            >
                                0{index + 1}
                            </span>
                            <p
                                className={cn(
                                    ...
                                    isActive &&
                                        "text-sundora-secondary-foreground border-none font-semibold",
                                )}
                            >
                                {uti.name}
                            </p>
