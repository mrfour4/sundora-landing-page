...
export const Location = () => {
    ...
    return (
        ...
        >
            <div
                className={cn(
                    "xs:text-4xl text-shadow-sundora-secondary text-center text-3xl font-light text-white uppercase text-shadow-[0_0_10px] lg:text-start lg:text-5xl",
                    albra.className,
                )}
            >
            ...
            <h2
                className={cn(
                    "xs:text-base from-sundora-secondary to-sundora-secondary-foreground -mt-3 bg-gradient-to-b bg-clip-text text-center text-sm leading-16 text-transparent lg:text-start lg:text-xl",
                    sparkling.className,
                )}
            >
