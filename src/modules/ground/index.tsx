  ...
  return (
    ...
    >
      <div>
        <h1
          className={cn(
            'text-center text-3xl font-light text-sundora-primary uppercase lg:text-start lg:text-5xl lg:leading-16',
            albra.className
          )}
        >
          mặt bằng tầng <br /> điển hình
        </h1>
        <GroupList activeIndex={activeIndex} onChange={setActiveIndex} />
      </div>
