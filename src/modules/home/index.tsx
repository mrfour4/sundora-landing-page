    ...
    return (
        ...
        >
            <div className="relative flex flex-1 flex-col items-center justify-end text-white lg:mx-20 lg:flex-row-reverse xl:mx-36 2xl:mx-56">
                <div className="top-40 right-32 z-10 text-center lg:absolute lg:top-36 lg:right-28 xl:top-56 xl:right-52">
                    <h1
                        className={cn(
                ...
                <div className="relative mt-6 flex w-full flex-col items-center justify-end lg:static">
                    <h2 className="top-0 left-0 z-10 text-base uppercase lg:absolute lg:mt-64 lg:ml-32 lg:-rotate-90">
                    ...
                    <p className="absolute top-40 right-0 bottom-0 mt-40 -translate-x-1/6 text-sm leading-5 tracking-widest italic lg:top-2/3 lg:right-72 lg:mt-0 lg:text-lg lg:leading-8 xl:right-96">
                        Sunshine <br />
                        Riverside <br />
                        Redefined
                    </p>
