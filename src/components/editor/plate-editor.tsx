...
import { Editor, EditorContainer } from "@/components/custom/editor";
        ...
        children: [
            ...
            },
            {
                children: [
                    {
                        children: [
                            { children: [{ text: "Suggestions" }], type: "p" },
                        ],
                        type: "td",
                    },
                    {
            ...
            },
            {
                children: [
                    {
                        children: [
                            { children: [{ text: "Emoji Picker" }], type: "p" },
                        ],
                        type: "td",
                    },
                    {
            ...
            },
            {
                children: [
                    {
                        children: [
                            { children: [{ text: "Drag Handle" }], type: "p" },
                        ],
                        type: "td",
                    },
                    {
